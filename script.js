...
function ready(){
    ...
    // Agreguemos funcionalidad a los botones eliminar del carrito
...
function eliminarItemCarrito(event){
    ...
    items.forEach(item => {
        ...
        item.addEventListener('click', () => {
            // Obtiene el elemento de descripción dentro del elemento "item"
            const descripcion = item.querySelector('.descripcion-item');
            // Cambia el estilo de la descripción para mostrarla u ocultarla
